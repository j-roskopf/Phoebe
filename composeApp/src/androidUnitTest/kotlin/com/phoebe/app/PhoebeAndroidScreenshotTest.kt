...
class PhoebeAndroidPhoneScreenshotTest {
    ...
    @Test fun phoneLibraryFlowDark() = capturePhone("library-flow", PhoebeScreenshotScenario.LibraryFlow)
...
class PhoebeAndroidTabletScreenshotTest {
    ...
    @Test fun tabletLibraryFlowDark() = captureTablet("library-flow", PhoebeScreenshotScenario.LibraryFlow)
